...
```{r}
# Gráfico de barras
gama_de_azules <- brewer.pal(n = 7, name = "Blues")

ggplot(data = mpg_class_avg, aes(x = reorder(class, -avg_city_mpg), y = avg_city_mpg, fill = class)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  scale_fill_manual(values = gama_de_azules)
