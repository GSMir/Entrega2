...
```{r}
# Cargar la biblioteca tidyverse si aún no está cargada
library(tidyverse)

# Crear el gráfico de densidad para comparar la distribución del rendimiento en ciudad
ggplot(data = mpg, aes(x = cty, fill = drv)) +
  geom_density(alpha = 0.5) +
  labs(
    title = "Distribución del Rendimiento en Ciudad por Tipo de Tracción",
